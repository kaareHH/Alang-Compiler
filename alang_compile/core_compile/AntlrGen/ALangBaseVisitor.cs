...
public partial class ALangBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IALangVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitDcls([NotNull] ALangParser.DclsContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitExpr([NotNull] ALangParser.ExprContext context) { return VisitChildren(context); }
	/// <summary>
