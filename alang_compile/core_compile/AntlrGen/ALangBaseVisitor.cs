...
public partial class ALangBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IALangVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitAlternative([NotNull] ALangParser.AlternativeContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitIflol([NotNull] ALangParser.IflolContext context) { return VisitChildren(context); }
	/// <summary>
